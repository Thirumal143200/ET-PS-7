...
**ET AI Hackathon 2026 — Problem Statement 7 Final Release**
...
## 🌐 Production Release Endpoints & URLs

- **Live Production Frontend**: [https://et-ps-7.vercel.app](https://et-ps-7.vercel.app) *(Vercel Free Tier)*
- **Live Production Backend API**: [https://cni-cyber-backend.onrender.com](https://cni-cyber-backend.onrender.com) *(Render Free Tier)*
- **Swagger / OpenAPI Interactive Docs**: [https://cni-cyber-backend.onrender.com/docs](https://cni-cyber-backend.onrender.com/docs)
- **Production System Health Endpoint**: [https://cni-cyber-backend.onrender.com/health](https://cni-cyber-backend.onrender.com/health)
...
## ☁️ Free Cloud Deployment Setup Guide

### 1. Database Deployment (Supabase PostgreSQL / Neon Free Tier)

1. Create a PostgreSQL project at [Supabase](https://supabase.com) or [Neon](https://neon.tech).
2. Copy your Connection String (`postgresql://postgres:[PASSWORD]@[HOST]:5432/cni_cyber_db?sslmode=require`).

### 2. Backend Deployment (Render Free Tier)

1. Connect your GitHub repository `Thirumal143200/ET-PS-7` to [Render](https://render.com).
2. Deploy using `render.yaml` or set environment variables:
...
2. Deploy using `vercel.json` and set environment variable:
...
# Run Automated Quality Gate Suite
...
npm run dev
```
Dashboard URL: `http://localhost:5173` or `http://localhost:3000`
